...
class _ProfileSource implements ProfileSource {
  _ProfileSource(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://teesas-staging.teesas.com//profile/';
  }
  ...
  @override
  Future<BaseDto> switchProfile(SwitchProfileDto payload) async {
  ...
  @override
  Future<BaseDto> getUserProfiles() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<BaseDto> updateProfile(
    ...
    _data.fields.add(MapEntry('country_id', countryId.toString()));
    _data.fields.add(MapEntry('gender', gender));
    if (profilePic != null) {
      _data.files.add(MapEntry('profile_pic', profilePic));
    }
    final _options = _setStreamType<BaseDto>(
      Options(
            method: 'POST',
